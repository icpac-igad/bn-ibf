...
\begin{frame}{Use of Climada to find $P^*$}

This project will use the Climada software library.

{\tiny \url{https://github.com/CLIMADA-project/climada_python}} 


The table below relates their 
terminology to ours.
...
In this
project, we use Climada for each flag $X^i\in\bool$.
