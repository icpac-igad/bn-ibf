...
\usepackage{authblk}
\title{Drought or Flood Warning Decision\\ made based on Bayesian Network}
...
When $x_\alp\neq  {\tt None}$, $x_\alp$ should be the
value of $x_\alp$ for some historical event or a bin value.
